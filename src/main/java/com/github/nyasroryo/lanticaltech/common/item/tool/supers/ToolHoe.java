...
public abstract class ToolHoe extends ItemHoe {
  private Item.ToolMaterial material;

  public static final String toolClass = "hoe";

  public ToolHoe(Item.ToolMaterial material, int durability, String name) {
    super(material);
  ...
  public ToolHoe(Item.ToolMaterial material, String name) {
